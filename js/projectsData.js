export const projects = [
  {
    ...
    year: '2019',
    image: {
      URL: './assets/images/analog_clock.png',
  ...
  },
  {
    ...
    technologies: ['html', 'css', 'javascipt', 'react.js', 'github', 'node.js', 'express', 'mySQL'],
  ...
  },
  {
    ...
    description:
      'At the end of my software development program at Udemy online, I was given this game as a project. The game test how a user can be able to remember clicking patterns thereby improving the user\s memory/retention. The UI is very interactive and engaging.',
  ...
  },
  {
    ...
    technologies: ['node.js', 'express', 'mySQL', 'github', 'dotenv', 'bcrypt', 'cors'],
    liveLink: 'https://ifit-api.herokuapp.com/',
    githubLink: 'https://github.com/HENRYKC24/IFIT-API',
  },
  {
    projectName: 'MY REACT SITE',
    canopy: 'WEBSITE',
    role: 'Full Stack Dev',
    year: '2020',
    image: {
  ...
  {
    projectName: 'SEEDSTAGE MOBILE',
    canopy: 'MOBILE',
    role: 'Front End Dev',
    year: '2021',
    image: {
      URL: './assets/seedstages_app_schedule_meeting.png',
    ...
    technologies: ['html', 'css', 'javascript', 'bitbucket', 'react', 'react-native', 'firebase',],
  ...
  },
  {
    ...
    year: '2021',
    image: {
      URL: './assets/seedstages_discover_talent.png',
      alt: 'Seedstages mobile application',
    },
    description:
      'This mobile app is developed by my team at Seedstages. When I joined Seedstage as a React Native Front End Engineer, I was being given series of tasks to carry out, one of which is to develope a screen that can send message to any talent discovered by companies. I did the coding and it was latered reviewed and merged to the main branch on bitbucket. The screen seeds an email to such talents/developer, who is looking for internship/full time opportunity.',
